...
class Sensors():
    ...
    def info(self):
        return f"Sensors: pitch={self.pitch:-5.2f}, yaw={self.yaw:-5.2f}"
        #return f"Sensors: roll={self.roll:-5.2f}, pitch={self.pitch:-5.2f}, yaw={self.yaw:-5.2f}, temperature={self.temperature:3}"
